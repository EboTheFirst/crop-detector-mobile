/**
 * Camera Screen for Crop Image Capture
 * Provides camera functionality with image capture, preview, and gallery selection
 */
...
export default function CameraScreen() {
  ...
  console.log('Camera component render - permission:', permission);
  console.log('Camera component render - capturedImage:', capturedImage);
  console.log('Camera component render - cameraError:', cameraError);
  ...
  if (!permission) {
    console.log('No permission object, showing loading...');
    return (
      <ThemedView style={[styles.container, styles.permissionContainer, { backgroundColor: screenBg }]}>
